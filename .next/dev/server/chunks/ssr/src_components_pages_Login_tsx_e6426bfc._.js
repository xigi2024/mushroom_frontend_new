module.exports = [
"[project]/src/components/pages/Login.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            if (result?.success) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success(result.message || "Login successful!");
                // Handle cart sync result
                if (result.cartSync) {
                    if (result.cartSync.success && result.cartSync.itemCount > 0) {
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success(result.cartSync.message || `${result.cartSync.itemCount} items transferred to your cart!`);
                    } else if (!result.cartSync.success) {
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].warning("Login successful, but failed to transfer cart items. Your items are still saved locally.");
                    }
                }
                ...
                setTimeout(()=>{
                    ...
                    const redirectAfterLogin = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : null;
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(error.message || "An error occurred during login. Please try again.");
        } finally{
...
//# sourceMappingURL=src_components_pages_Login_tsx_e6426bfc._.js.map